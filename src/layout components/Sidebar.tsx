  ...
  return (
    ...
    >
        <div className='flex justify-start pb-4 flex-col'>
          <Link to='/' className='flex justify-center mb-4 pb-3 border-b-2 border-gray-200'>
          ...
          <div className={`flex flex-col space-y-2 mt-2 ${!expanded ? 'justify-center' : ''}`}>
            <p className={`text-text_primary text-xs ${!expanded ? 'text-center' : ''}`}>Main</p>
            <div className='flex flex-col justify-around space-y-1 text-text_primary'>
                {/* Dashboard */}
                <NavLink
                  to='/Dashboard'
                  className={({isActive}) =>
          ...
          {/* Settings Div */}
          <div className='flex flex-col space-y-2 mt-4 pt-4 border-t-2 border-gray-200'>
