...
const sampleGigHistoryData: GigsTableType[] = [
  {
  ...
  {
    EventName: 'Urban Art & Sound',
    EventManager: 'Sarah Mitchell',
    Location: 'Chicago, IL',
    Amount: 887,
    DateTime: 'Apr 25, 2025, 8:30 pm',
    GigType: 'SOLO',
    Status: 'Canceled',
  },
  {
    EventName: 'Sunset Music Festival',
    EventManager: 'Amanda Li',
    Location: 'Austin, TX',
    Amount: 2899,
  ...
  },
  {
    ...
    EventManager: 'Lisa Watson',
    Location: 'Las Vegas, NV',
    Amount: 3899,
    DateTime: 'May 04, 2025 7:00 pm',
    GigType: 'BAND',
    Status: 'Canceled',
  },
  {
...
export default sampleGigHistoryData;