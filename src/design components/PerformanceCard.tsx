  ...
  return (
    <button 
      className="bg-white rounded-2xl border border-black/2 shadow-[0_4px_6px_0_rgba(0,0,0,0.1)] 
       h-[400px] w-full max-w-[285px] mr-4"
    ...
    >
      ...
      <section className="flex flex-col justify-around p-4">
        ...
        <p className="font-semibold text-md font-inter">{title}</p>
        ...
        {/* Description */}
        <p className='text-text_secondary text-sm font-lato'>{description}</p>
      </section>
    </button>
  )
}
