...
// TODO: Fix sizing for small-med screens
...
const DashBookingTable = () => {
  ...
  return (
    <div className='bg-[#fbfbfb] p-4 h-full'>
      <h5 className='font-medium text-sm  py-2'>Gig Booking Requests</h5>
      <table className='border-separate border-spacing-y-2 border-spacing-x-1 md:border-spacing-x-2 xl:border-spacing-x-8'>
        <tbody>
